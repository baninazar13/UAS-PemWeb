...
<html>
	<head>
		<title>CRUD Pencatatan Surat Keluar</title>
	...
	<body>
		...
		<!-- JUDUL APLIKASI -->
	<div class="container">
		<h3 class='text-center'>CRUD Pencatatan Surat Keluar</h3><hr>
			...
			<div class="col-md-5">
				<form id='frm'>
				  <div class="form-group">
					...
					<input type="nomor" class="form-control" name="nomor" id='nomor' required placeholder="Isi nomor....">
				  </div>
				  <div class="form-group">
					<label>Tanggal</label>
					<input type="date" class="form-control" name="tanggal" id='tanggal' required placeholder="Pilih tanggal">
				  </div>
				  <div class="form-group">
					<label>Judul Surat</label>
					<input type="judul" class="form-control"  name="judul" id='judul' required placeholder="Isi judul....">
				  </div>
	...
	<script>
		$(document).ready(function(){
			...
			$("body").on("click",".edit",function(e){
				...
				$("#tanggal").val(tanggal);
				var judul=row.closest("tr").find("td:eq(2)").text();
				$("#judul").val(judul);
